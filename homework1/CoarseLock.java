...
public class CoarseLock {
	...
	public static class CoarseLockRunnableThread implements Runnable{

		public int start;
		public int end;

		public CoarseLockRunnableThread(int start, int end) {
			this.start = start;
			this.end = end;
		}
	...
	public static HashMap<String, Station> performCoarseLock(ArrayList<String> input) {
		inputData= input;
		...
		for(int i= 0; i<processors; i++){
			...
			executor.execute(new CoarseLockRunnableThread(start, end));
			start = end;
		}
		executor.shutdown();
